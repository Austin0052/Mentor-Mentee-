...
const ClassLinks = 'flex item-center gap-2 p-3 font-light px-3 hover:bg-gradient-to-r hover:from-blue-800 hover:to-blue-100 hover:no-underline hover:text-white active:bg-neutral-600 rounded-md text-base'
function SideLink({item}){
  const {pathname} = useLocation();
  return(
    <Link to={item.path} className={classNames(pathname === item.path ? 'text-white bg-gradient-to-r from-blue-800 to-blue-100': 'text-black',ClassLinks)}>
